(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("node-forge"), require("bitcore-message"), require("jsonld"));
	else if(typeof define === 'function' && define.amd)
		define(["node-forge", "bitcore-message", "jsonld"], factory);
	else if(typeof exports === 'object')
		exports["jsonld-signatures"] = factory(require("node-forge"), require("bitcore-message"), require("jsonld"));
	else
		root["jsonld-signatures"] = factory(root["forge"], root["bitcoreMessage"], root["jsonld"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_node_forge__, __WEBPACK_EXTERNAL_MODULE_bitcore_message__, __WEBPACK_EXTERNAL_MODULE_jsonld__) {
...
"use strict";
eval("/*!\n * Copyright (c) 2017-2018 Digital Bazaar, Inc. All rights reserved.\n */\n\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"./node_modules/@babel/runtime/helpers/interopRequireDefault.js\");\n\nvar _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\"));\n\nvar _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/classCallCheck.js\"));\n\nvar _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/createClass.js\"));\n\nvar _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ \"./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js\"));\n\nvar _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ \"./node_modules/@babel/runtime/helpers/getPrototypeOf.js\"));\n\nvar _get2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/get */ \"./node_modules/@babel/runtime/helpers/get.js\"));\n\nvar _inherits2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/inherits */ \"./node_modules/@babel/runtime/helpers/inherits.js\"));\n\nvar forge = __webpack_require__(/*! node-forge */ \"node-forge\");\n\nvar LinkedDataSignature2015 = __webpack_require__(/*! ./LinkedDataSignature2015 */ \"./lib/suites/LinkedDataSignature2015.js\");\n\nmodule.exports =\n/*#__PURE__*/\nfunction (_LinkedDataSignature) {\n  (0, _inherits2[\"default\"])(EcdsaKoblitzSignature2016, _LinkedDataSignature);\n\n  function EcdsaKoblitzSignature2016() {\n    var _this;\n\n    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},\n        privateKeyWif = _ref.privateKeyWif,\n        publicKeyWif = _ref.publicKeyWif,\n        creator = _ref.creator,\n        date = _ref.date,\n        domain = _ref.domain,\n        nonce = _ref.nonce,\n        useNativeCanonize = _ref.useNativeCanonize;\n\n    (0, _classCallCheck2[\"default\"])(this, EcdsaKoblitzSignature2016);\n    _this = (0, _possibleConstructorReturn2[\"default\"])(this, (0, _getPrototypeOf2[\"default\"])(EcdsaKoblitzSignature2016).call(this, {\n      type: 'EcdsaKoblitzSignature2016',\n      creator: creator,\n      date: date,\n      domain: domain,\n      nonce: nonce,\n      useNativeCanonize: useNativeCanonize\n    }));\n    _this.privateKeyWif = privateKeyWif;\n    _this.publicKeyWif = publicKeyWif;\n    return _this;\n  }\n\n  (0, _createClass2[\"default\"])(EcdsaKoblitzSignature2016, [{\n    key: \"sign\",\n    value: function sign(_ref2) {\n      var verifyData, proof, bitcoreMessage, bitcore, privateKey, message;\n      return _regenerator[\"default\"].async(function sign$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              verifyData = _ref2.verifyData, proof = _ref2.proof;\n\n              if (!(typeof this.privateKeyWif !== 'string')) {\n                _context.next = 3;\n                break;\n              }\n\n              throw new TypeError('\"privateKeyWif\" must be a base58 formatted string.');\n\n            case 3:\n              bitcoreMessage = __webpack_require__(/*! bitcore-message */ \"bitcore-message\");\n              bitcore = bitcoreMessage.Bitcore;\n              privateKey = bitcore.PrivateKey.fromWIF(this.privateKeyWif);\n              message = bitcoreMessage(forge.util.binary.raw.encode(verifyData));\n              proof.signatureValue = message.sign(privateKey);\n              return _context.abrupt(\"return\", proof);\n\n            case 9:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, null, this);\n    }\n  }, {\n    key: \"verifySignature\",\n    value: function verifySignature(_ref3) {\n      var verifyData, proof, bitcoreMessage, message;\n      return _regenerator[\"default\"].async(function verifySignature$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              verifyData = _ref3.verifyData, proof = _ref3.proof;\n              bitcoreMessage = __webpack_require__(/*! bitcore-message */ \"bitcore-message\");\n              message = bitcoreMessage(forge.util.binary.raw.encode(verifyData));\n              return _context2.abrupt(\"return\", message.verify(this.publicKeyWif, proof.signatureValue));\n\n            case 4:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, null, this);\n    }\n  }, {\n    key: \"getVerificationMethod\",\n    value: function getVerificationMethod(_ref4) {\n      var proof, documentLoader, verificationMethod;\n      return _regenerator[\"default\"].async(function getVerificationMethod$(_context3) {\n        while (1) {\n          switch (_context3.prev = _context3.next) {\n            case 0:\n              proof = _ref4.proof, documentLoader = _ref4.documentLoader;\n              _context3.next = 3;\n              return _regenerator[\"default\"].awrap((0, _get2[\"default\"])((0, _getPrototypeOf2[\"default\"])(EcdsaKoblitzSignature2016.prototype), \"getVerificationMethod\", this).call(this, {\n                proof: proof,\n                documentLoader: documentLoader\n              }));\n\n            case 3:\n              verificationMethod = _context3.sent;\n\n              if (!(typeof verificationMethod.publicKeyWif !== 'string')) {\n                _context3.next = 6;\n                break;\n              }\n\n              throw new TypeError('Unknown public key encoding. Public key encoding must be ' + '\"publicKeyWif\".');\n\n            case 6:\n              if (!this.publicKeyWif) {\n                this.publicKeyWif = verificationMethod.publicKeyWif;\n              }\n\n              return _context3.abrupt(\"return\", verificationMethod);\n\n            case 8:\n            case \"end\":\n              return _context3.stop();\n          }\n        }\n      }, null, this);\n    }\n  }]);\n  return EcdsaKoblitzSignature2016;\n}(LinkedDataSignature2015);\n\n//# sourceURL=webpack://%5Bname%5D/./lib/suites/EcdsaKoblitzSignature2016.js?");
...
/***/ "bitcore-message":
/*!*****************************************************************************************************************************!*\
  !*** external {"amd":"bitcore-message","commonjs":"bitcore-message","commonjs2":"bitcore-message","root":"bitcoreMessage"} ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = __WEBPACK_EXTERNAL_MODULE_bitcore_message__;\n\n//# sourceURL=webpack://%5Bname%5D/external_%7B%22amd%22:%22bitcore-message%22,%22commonjs%22:%22bitcore-message%22,%22commonjs2%22:%22bitcore-message%22,%22root%22:%22bitcoreMessage%22%7D?");
